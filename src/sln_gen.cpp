...
bool sln_createSourceFile(ztBuildConfig *build_cfg, const char *proj_dir, const char *src_file)
{
	...
	if (zt_strEquals(src_file, "src\\" SRC_FILE_UNITY_FULL)) {
		...
		zt_fileWritef(&file,
			...
			"	r32                    game_state_transition_time;\n"
		...
		zt_fileWritef(&file,
			...
			"	GameStateMain *gs = &game->game_state_main;\n\n"
			"	if (game->game_state_transition_to != GameState_Invalid || game->fade_time > 0) {\n"
			"			return true;\n"
			"	}\n"
			"\n"
			...
			"			gameTransitionTo(game, GameState_Main, false);\n"
			"		}\n"
			"		return true;\n"
			"	}\n\n"
		...
		zt_fileWritef(&file,
			...
			"	game->game_state_transition_time = 0;\n\n"
...
/*		if (build_cfg->include_3d_scene) {
		...
		zt_fileWritef(&file,
			"}\n\n"
			"// ================================================================================================================================================================================================\n\n"
			"void gameTransitionTo(ztGame *game, GameState_Enum state, bool immediately)\n"
			"{\n"
			"	game->game_state_transition_to = state;\n"
			"\n"
			"	if (immediately) {\n"
			"		game->game_state_transition_time = 0;\n"
			"	}\n"
			...
			"		game->game_state_transition_time = transition_time;\n"
		...
		zt_fileWritef(&file,
			...
			"		game->game_state_transition_time -= dt;\n"
			"		if (game->game_state_transition_time < 0) {\n"
			...
			"			}\n"
			"\n"
			"			zt_drawListAddSolidRect2D(&game->draw_list, ztVec3::zero, ztVec2(128, 128), ztColor(0, 0, 0, alpha));\n"
			"		}\n"
			"\n"
